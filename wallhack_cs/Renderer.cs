...
namespace wallhack_cs
{
    public class Renderer : Overlay
    {
        ...
        public Vector4 enemyColor = new Vector4(1f, 0f, 0f, 1f);
        public Vector4 textColor = new Vector4(1f, 1f, 1f, 1f);
        public Vector4 skeletonColor = new Vector4(1f, 1f, 1f, 1f);
        public Vector4 visibleColor = new Vector4(0f, 1f, 0f, 1.0f);
        ...
        private void RenderMenu()
        {
            ...
            ImGui.Checkbox("Weapons", ref weapon);
